;(function(window) {
  var adjectives = [
    'acceptable', 'actual', 'adaptable', 'adorable', 'aerial', 'affectionate', 'agile', 'agreeable', 'alert', 'alluring', 'ambidextrous', 'ambiguous', 'ambitious', 'amused', 'amusing', 'androgynous', 'aquatic', 'artistic', 'authentic', 'avid', 'awakening',
    'big', 'bionic', 'beautiful', 'blissful', 'blooming', 'boundless', 'bountiful', 'brave', 'bright', 'brilliant', 'burning',
    'calm', 'capable', 'charming', 'cheerful', 'chic', 'civil', 'coherent', 'comfortable', 'compassionate', 'competent', 'confident', 'content', 'cool', 'cooperative', 'courageous', 'credible', 'cultured', 'cute',
  ...
  var nouns = [
    ...
    'hair', 'haircut', 'hall', 'hammer', 'hand', 'hands', 'harbor', 'harmony', 'hat', 'hate', 'head', 'health', 'heart', 'heat', 'help', 'hen', 'hill', 'history', 'hobby', 'holiday', 'home', 'honey', 'hook', 'hope', 'horn', 'horse', 'hose', 'hospital', 'hour', 'house', 'human', 'humor',
    ...
    'lace', 'ladybug', 'lake', 'lamp', 'land', 'landmark', 'language', 'laugh', 'lawyer', 'lead', 'leaf', 'leather', 'leg', 'legs', 'lemon', 'letter', 'lettuce', 'level', 'library', 'lift', 'light', 'limit', 'line', 'linen', 'lip', 'lips', 'liquid', 'list', 'lizard', 'loaf', 'lock', 'locket', 'look', 'loss', 'love', 'lumber', 'lunch', 'lunchroom',
    'machine', 'mage', 'magic', 'magician', 'mailbox', 'manager', 'map', 'marble', 'mark', 'market', 'mask', 'mass', 'match', 'meal', 'measure', 'meat', 'meeting', 'memory', 'metal', 'middle', 'milk', 'mind', 'mine', 'minister', 'mint', 'minute', 'mist', 'mitten', 'mom', 'money', 'monkey', 'month', 'moon', 'moose', 'morning', 'motion', 'mountain', 'mouse', 'mouth', 'muscle', 'music',
    ...
    'table', 'tail', 'talk', 'tank', 'taste', 'tax', 'tea', 'team', 'teeth', 'temper', 'tendency', 'tent', 'territory', 'test', 'text', 'texture', 'theory', 'thing', 'thought', 'thread', 'thrill', 'throat', 'throne', 'thumb', 'thunder', 'ticket', 'tiger', 'time', 'tin', 'title', 'toad', 'tomato', 'tongue', 'tooth', 'toothbrush', 'toothpaste', 'top', 'touch', 'town', 'toy', 'trade', 'trail', 'train', 'trampoline', 'transport', 'tray', 'treatment', 'tree', 'trick', 'trip', 'trouble', 'trousers', 'truck', 'tub', 'turkey', 'turn', 'twig', 'twist',
    ...
    'walk', 'wall', 'war', 'warlock', 'warrior', 'wash', 'waste', 'watch', 'water', 'wave', 'wax', 'way', 'wealth', 'weather', 'week', 'weight', 'wheel', 'whip', 'whistle', 'wilderness', 'wind', 'wine', 'wing', 'wink', 'winter', 'wire', 'wish', 'witch', 'wizard', 'wood', 'wool', 'word', 'work', 'worm', 'wound', 'wrench', 'wrist', 'writer',
    'xenon', 'xylophone',
