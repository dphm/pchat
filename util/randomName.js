;(function(exports) {
  var adjectives = [
    'actual', 'adaptable', 'adorable', 'aerial', 'affectionate', 'agile', 'agreeable', 'alert', 'alluring', 'ambidextrous', 'ambitious', 'amused', 'amusing', 'aquatic', 'artistic', 'authentic', 'avid', 'awakening',
  ...
  var nouns = [
    ...
    'dad', 'daughter', 'day', 'death', 'debt', 'decision', 'deer', 'degree', 'design', 'designer', 'desire', 'desk', 'desert', 'dessert', 'destruction', 'detail', 'development', 'dime', 'dinner', 'dinosaur', 'direction', 'director', 'dirt', 'discovery', 'discussion', 'disease', 'disgust', 'distance', 'distribution', 'division', 'dock', 'doctor', 'dog', 'doll', 'donkey', 'door', 'downtown', 'drain', 'drawer', 'dress', 'drink', 'driving', 'drop', 'drug', 'drum', 'duck', 'dust',
    ...
    'lace', 'ladybug', 'lake', 'lamp', 'land', 'landmark', 'language', 'laugh', 'lawyer', 'lead', 'leaf', 'learning', 'leather', 'leg', 'legs', 'letter', 'lettuce', 'level', 'library', 'lift', 'light', 'limit', 'line', 'linen', 'lip', 'lips', 'liquid', 'list', 'lizard', 'loaf', 'lock', 'locket', 'look', 'loss', 'love', 'low', 'lumber', 'lunch', 'lunchroom',
